...
class EditDataTimeDialog extends StatefulWidget {
  const EditDataTimeDialog({
    super.key,
  });

  @override
  State<EditDataTimeDialog> createState() => _EditDateTimeState();
}

class _EditDateTimeState extends State<EditDataTimeDialog> {
                  ...
                  FilledButton(
                    onPressed: () {
                      if (_selectedDay != null) {
                        ...
                        //Here we are showing the timer dialog and then
                        context.read<HomeBloc>().add(
                              OnEditDateButtonClickedEvent(
